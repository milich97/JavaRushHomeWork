...
Реализовать метод addPrice(int applesPrice), чтобы при его вызове суммарная стоимость яблок увеличивалась на переданное значение.
...
public class Solution
{
    ...
    public static class Apple{
        ...
        public static void addPrice(int applesPrice1){
            applesPrice=applesPrice+applesPrice1;
        }
    }
}
